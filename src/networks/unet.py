# source code was obtained from: https://github.com/milesial/Pytorch-UNet
...
class UNet(nn.Module):
    def __init__(self,
        ...
        self.up1 = Up(filters[4], filters[3] // factor, nearest)
        self.up2 = Up(filters[3], filters[2] // factor, nearest)
        self.up3 = Up(filters[2], filters[1] // factor, nearest)
        self.up4 = Up(filters[1], filters[0], nearest)
