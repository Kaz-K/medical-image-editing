...
class StyledVQWNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.styled_up_conv2_4 = StyledResUpBlock(filters[4], filters[3], filters[3])
        self.styled_up_conv2_3 = StyledResUpBlock(filters[3], filters[2], filters[2])
        self.styled_up_conv2_2 = StyledResUpBlock(filters[2], filters[1], filters[1])
        self.styled_up_conv2_1 = StyledResUpBlock(filters[1], filters[0], filters[0])
    ...
    def forward(self, x):
        ...
        x = self.styled_up_conv2_4(x, skip2_4_out)
        x = self.styled_up_conv2_3(x, skip2_3_out)
        x = self.styled_up_conv2_2(x, skip2_2_out)
        x = self.styled_up_conv2_1(x, skip2_1_out)
